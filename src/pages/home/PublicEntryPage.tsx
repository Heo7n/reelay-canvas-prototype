...
export function PublicEntryPage() {
  ...
  function openLogin(): void {
    ...
    const search = draft.workspaceId ? `?${new URLSearchParams({ returnTo: routePaths.workspaceHome(draft.workspaceId) })}` : "";
    void navigate(`${routePaths.login()}${search}`, { preventScrollReset: true });
  }
