import { DEMO_ENTITY_FIXTURES as PUBLIC_DEMO_ENTITY_FIXTURES } from "../../config/entity-demo-fixtures";
...
export { DEMO_ASSET_FIXTURES } from "../../config/entity-demo-fixtures";

// Existing creation slots stay server-only so published upgrades retain identity.
const ENTITY_CREATION_KEYS: Readonly<Record<string, string>> = {
  umbra: MIST_COURIER_CREATE_KEY,
  baixi: OBSIDIAN_PROBE_CREATE_KEY,
  xuanling: "reelay-demo-entity-library-v4-entity-xuanling",
};

export const DEMO_ENTITY_FIXTURES: readonly DemoEntityFixture[] = PUBLIC_DEMO_ENTITY_FIXTURES.map((fixture) => ({
  ...fixture,
  createIdempotencyKey: ENTITY_CREATION_KEYS[fixture.key]!,
}));
