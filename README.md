...
- 全部项目：个人 / 协作项目是不同工作空间投影，支持本地搜索、PostgreSQL 持久化的新建与重命名、协作标识、快捷改名笔和统一三点菜单；修改封面、转换归属和删除尚未接入。
...
- 数据层：会话、Workspace、Membership 和 Project 已使用 PostgreSQL repository、带 checksum 的顺序迁移与幂等 demo seed；画布文档、素材、命令历史、生成任务和积分账本仍未持久化。
