...
test("connection ports keep their external field while media frames accept body drops", async () => {
  ...
  assert.match(html, /styles\.css\?v=20260907-media-toolbar-proportions-105/);
  assert.match(html, /app\.js\?v=20260907-media-toolbar-proportions-105/);
...
test("canvas chrome keeps compact left zones and an independently sized Agent dock", () => {
  assert.match(stylesEntry, /styles\/app\.css\?v=20260907-media-toolbar-proportions-105/);
  assert.match(stylesEntry, /styles\/canvas-chrome\.css\?v=20260907-asset-toggle-alignment-99/);
  assert.match(stylesEntry, /styles\/canvas-asset-library\.css\?v=20260907-asset-toggle-alignment-99/);
...
test("asset library actions stay scoped to their real controls and canvas drop target", () => {
  ...
  assert.match(html, /styles\.css\?v=20260907-media-toolbar-proportions-105/);
  assert.match(html, /prototype-config\.js\?v=20260907-media-toolbar-proportions-105/);
