...
test("generator Entity entry expands the chip rail only for supported prompt panels", () => {
  ...
  assert.match(entityUseCss, /\.generator-node \.asset-shelf \{\s*left: calc\(16px \+ var\(--reference-cell-size\) \+ var\(--reference-cell-gap\)\);/);
  assert.match(entityUseCss, /\.generator-node \.prompt-panel\.has-entity-entry \.entity-drop \{\s*left: 16px;/);
  assert.match(entityUseCss, /\.generator-node \.prompt-panel\.has-entity-entry \.asset-drop \{\s*left: calc\(16px \+ var\(--reference-cell-size\) \+ var\(--reference-cell-gap\)\);/);
  assert.match(entityUseCss, /\.generator-node \.prompt-panel\.has-entity-entry \.asset-shelf \{\s*left: calc\(16px \+ 2 \* \(var\(--reference-cell-size\) \+ var\(--reference-cell-gap\)\)\);/);
